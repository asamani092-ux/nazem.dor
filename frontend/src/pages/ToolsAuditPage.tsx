...
const TOOL_HELP: Partial<Record<string, string>> = {
  ...
  'file-upload':
    'رفع المرفق من رصد المعلمة (مرفق الفصل لكل أسبوع). يُحفظ على الخادم ويظهر: للمديرة في تبويب «المرفقات» مقسّماً حسب الفصل والأسبوع، وللمشرفة في تبويب «المرفقات» كمؤشر رفع أسبوعي مع معاينة.',
};
